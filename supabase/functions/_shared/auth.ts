 ...
 *   "https://www.upnext.no,https://app.upnext.no,http://localhost:5173"
 *
 ...
 * ALLOWED_ORIGIN, or https://www.upnext.no.
 */
...
const DEFAULT_WHITELIST = [
  'https://www.upnext.no',
  'https://upnext.no',
  // Legacy domains — redirect to upnext.no; keep until the redirects have
  // been live long enough that no cached clients still call from them.
  'https://www.raden.no',
  'https://raden.no',
