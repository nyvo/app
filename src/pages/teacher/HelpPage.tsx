          ...
          <form className="flex flex-col gap-5" onSubmit={handleSubmit}>
            <div className="flex flex-col gap-1.5">
              ...
              <Select value={subject} onValueChange={setSubject}>
                <SelectTrigger id="help-subject" className="w-full bg-background">
              ...
              <>
                <div className="flex flex-col gap-1.5">
                  ...
                  <Select value={courseId} onValueChange={setCourseId} disabled={loadingCourses}>
                    <SelectTrigger id="help-course" className="w-full bg-background">
                ...
                {showSignupField && (
                  <div className="flex flex-col gap-1.5">
                    ...
                    <Select value={signupId} onValueChange={setSignupId} disabled={loadingSignups}>
                      <SelectTrigger id="help-signup" className="w-full bg-background">
