      ...
      <main className="flex-1 px-4 sm:px-6 py-12">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="space-y-12">
            ...
            <section>
              <h2 className="text-sm font-medium text-text-primary mb-4">2. Avbestilling</h2>
              <p className="text-text-secondary leading-relaxed mb-4 text-sm">
            ...
            <section>
              <h2 className="text-sm font-medium text-text-primary mb-4">3. Ansvar</h2>
              <p className="text-text-secondary leading-relaxed mb-4 text-sm">
            ...
            <section>
              <h2 className="text-sm font-medium text-text-primary mb-4">4. Personvern</h2>
              <p className="text-text-secondary leading-relaxed text-sm">
            ...
            <section>
              <h2 className="text-sm font-medium text-text-primary mb-4">5. Endringer</h2>
              <p className="text-text-secondary leading-relaxed text-sm">
