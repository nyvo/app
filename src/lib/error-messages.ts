...
const PG_CODE_MESSAGES: Record<string, string> = {
  '23505': 'Dette finnes allerede. Sjekk opplysningene og prøv igjen.',  // unique_violation
  '23503': 'Noe mangler. Last siden på nytt.',                           // foreign_key_violation
...
const MESSAGE_PATTERNS: [RegExp, string][] = [
  [/duplicate key.*unique_active_signup_per_course_email/i,
    'Denne e-postadressen er allerede påmeldt dette kurset.'],
  [/duplicate key/i,
    'Dette finnes allerede. Sjekk opplysningene og prøv igjen.'],
  ...
  [/stripe_onboarding_required|payment_setup_required/i,
    'Fullfør betalingsoppsettet før du publiserer kurset.'],
  ...
  [/incorrect_cvc/i,
    'CVC-koden stemmer ikke. Sjekk kortet og prøv igjen.'],
  [/processing_error/i,
