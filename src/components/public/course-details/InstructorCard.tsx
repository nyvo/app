  ...
  return (
    <div className="flex items-center gap-3">
      ...
      <div className="flex-1 min-w-0">
        ...
        {role && (
          <div className="text-xs font-medium tracking-wide text-muted-foreground">{role}</div>
        )}
      </div>
      {profileUrl && (
        <Link
          to={profileUrl}
          className="text-xs font-medium tracking-wide shrink-0 text-muted-foreground transition-colors hover:text-foreground"
        >
          Se profil
        </Link>
      )}
