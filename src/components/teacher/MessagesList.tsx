...
export const MessagesList = memo(function MessagesList({ messages }: MessagesListProps) {
  return (
    <div className="col-span-1 md:col-span-3 lg:col-span-2 h-[360px] rounded-2xl bg-white border border-zinc-200 overflow-hidden ios-ease hover:border-zinc-400 hover:bg-zinc-50/50 flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto p-2 space-y-2 flex flex-col">
        {messages.length === 0 ? (
          <div className="flex-1 flex flex-col items-center justify-center text-center mx-2 my-2 rounded-2xl bg-surface/30 border border-dashed border-zinc-200">
