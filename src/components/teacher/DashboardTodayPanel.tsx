        ...
        <div className="space-y-1">
          {courses.map((course) => (
            <Link
              ...
              className="group flex items-center justify-between gap-4 rounded-lg px-2 py-3 outline-none smooth-transition hover:bg-surface-muted/50 focus-visible:bg-surface-muted/50"
            >
              <div className="min-w-0">
                <p className="type-label truncate text-foreground">{course.title}</p>
                <p className="type-body-sm mt-1 text-muted-foreground">{course.subtitle}</p>
              </div>
