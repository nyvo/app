    ...
    <Popover open={open} onOpenChange={(isOpen) => {
      ...
      <PopoverTrigger asChild>
        <button
          ...
          className={cn(
            'flex h-11 w-full items-center justify-between gap-2.5 rounded-xl border border-transparent bg-muted px-4 text-base text-foreground outline-none transition-[color,border-color,box-shadow] duration-150 ease-out focus-visible:border-foreground focus-visible:ring-2 focus-visible:ring-foreground/15 disabled:cursor-not-allowed disabled:bg-muted/60 disabled:opacity-50 aria-invalid:border-danger aria-invalid:ring-2 aria-invalid:ring-danger/20',
