    ...
    <Popover open={open} onOpenChange={(isOpen) => {
      ...
      <PopoverTrigger asChild>
        <button
          ...
          className={cn(
            'motion-color flex h-10 w-full items-center justify-between gap-2.5 rounded-xl border border-border bg-surface px-4 text-base text-foreground outline-none focus-visible:border-foreground focus-visible:ring-2 focus-visible:ring-ring-subtle disabled:cursor-not-allowed disabled:bg-muted disabled:opacity-50 aria-invalid:border-danger aria-invalid:ring-2 aria-invalid:ring-danger/20',
