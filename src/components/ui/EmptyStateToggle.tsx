...
const EmptyStateToggle = () => {
  ...
  return (
    <button
      ...
      className="fixed bottom-4 right-4 z-50 flex items-center gap-2 rounded-full border border-border bg-white px-3 py-1.5 text-xs font-medium transition-all hover:scale-105 active:scale-95"
