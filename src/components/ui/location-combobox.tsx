  ...
  if (!hasOptions) {
    return (
      <input
        ...
        className={cn(
          'flex h-9 w-full items-center rounded-lg border border-input bg-surface px-4 py-2 text-[14px] font-medium ring-offset-background placeholder:font-normal placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50',
          className
        )}
        {...ariaProps}
      />
