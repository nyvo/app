  ...
  if (!hasOptions) {
    return (
      <input
        ...
        className={cn(
          'flex h-11 w-full items-center rounded-xl border border-border bg-surface px-4 text-base font-medium transition-[color,border-color,box-shadow] duration-150 ease-out placeholder:font-normal placeholder:text-foreground-muted focus-visible:outline-none focus-visible:border-foreground focus-visible:ring-2 focus-visible:ring-foreground/15 disabled:cursor-not-allowed disabled:opacity-50',
          className
        )}
        {...ariaProps}
      />
    ...
    <Popover open={open} onOpenChange={setOpen}>
      ...
      <PopoverContent className="w-[var(--radix-popover-trigger-width)] p-0" align="start">
        <input
          ...
          className="block h-11 w-full border-0 bg-transparent px-4 text-base font-medium placeholder:font-normal placeholder:text-foreground-muted focus:outline-none"
          autoFocus
        />
