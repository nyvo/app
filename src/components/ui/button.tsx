 ...
 *   cta      44px   px-6     text-sm    Public/mobile primary CTAs + auth
 *                                       controls (2026-07-22: 40 → 44 — the
 *                                       conversion surfaces get the full touch
 *                                       target; text stays 14px. Auth inputs
 *                                       are h-11 to match — buttons share rows
 *                                       with fields)
...
const buttonVariants = cva(
  "motion-press group/button inline-flex shrink-0 items-center justify-center rounded-full border border-transparent bg-clip-padding text-sm font-medium whitespace-nowrap outline-none select-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:text-foreground-disabled aria-invalid:border-danger aria-invalid:ring-2 aria-invalid:ring-danger/20 dark:aria-invalid:border-danger/50 dark:aria-invalid:ring-danger/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 cursor-pointer",
  {
    variants: {
      variant: {
