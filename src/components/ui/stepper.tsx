 ...
 * - Track: completed segments primary, upcoming light grey (border).
          ...
          {total > 1 &&
            Array.from({ length: total - 1 }).map((_, i) => (
              <span
                ...
                className={cn(
                  'flex-1',
                  clampedStep > i ? 'bg-primary' : 'bg-border'
                )}
              />
            ))}
        </div>
              ...
              >
                {isClickable ? (
                  <button
                    ...
                    className="flex flex-col items-center rounded-lg py-1 px-2 -mx-2 focus:outline-none focus-visible:ring-2 focus-visible:ring-ring/50"
