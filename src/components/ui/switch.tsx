...
function Switch({
  ...
  return (
    <SwitchPrimitive.Root
      ...
      data-size={size}
      className={cn(
        "motion-color peer group/switch relative inline-flex shrink-0 items-center rounded-full border border-transparent outline-none after:absolute after:left-1/2 after:top-1/2 after:size-11 after:-translate-x-1/2 after:-translate-y-1/2 focus-visible:border-foreground focus-visible:ring-2 focus-visible:ring-ring-subtle aria-invalid:border-danger aria-invalid:ring-2 aria-invalid:ring-danger/20 data-[size=default]:h-[18px] data-[size=default]:w-[32px] data-[size=sm]:h-[14px] data-[size=sm]:w-[24px] dark:aria-invalid:border-danger dark:aria-invalid:ring-danger data-checked:bg-primary data-unchecked:bg-border-strong dark:data-unchecked:bg-border-strong data-disabled:cursor-not-allowed data-disabled:opacity-50",
        className
      )}
      {...props}
    >
